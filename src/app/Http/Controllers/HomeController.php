...
class HomeController extends Controller
{
    ...
    public function getIndexData()
    {
        ...
        $topics=DB::table('topics as t')
                ...
                ->select('t.id','tb.key','t.title','t.image','tm.thumbnail_type','t.text','t.owner','t.url','t.upload','m.bgm_created_name','m.bgm_name','ani.animation_type',DB::raw("false as favorite"))
